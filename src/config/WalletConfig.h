...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "EGC";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "EGC";
    ...
    const std::string daemonName = "EuGoldCoind";

    /* The name to call this wallet */
    const std::string walletName = "Jackwallet";
    ...
    const std::string contactLink = "http://eugoldcoin.com";
