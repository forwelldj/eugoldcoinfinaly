...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 362750;
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001ffffffffffff0f029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd08807121013c9acaf9e5da0adf1a7872a5ce770a0a449dac8be1f73b58dcc58b1d824e2e42";
...
const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "eugoldblocks.bin";
const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "eugoldblockindexes.bin";
const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "eupoolstate.bin";
const char     P2P_NET_DATA_FILENAME[]                       = "p2pstatefelice.bin";
const char     MINER_CONFIG_FILE_NAME[]                      = "bellaminer_conf.json";
} // parameters

const char     CRYPTONOTE_NAME[]                             = "EuGoldCoin";
...
const int      P2P_DEFAULT_PORT                              =  18308;
const int      RPC_DEFAULT_PORT                              =  18309;
...
{
    {  0x4a, 0x41, 0x43, 0x4b, 0x42, 0x52, 0x45, 0x55, 0x47, 0x4f, 0x4c, 0x44, 0x43, 0x4f, 0x49, 0x4e  } 
};

const char* const SEED_NODES[] = {
       "95.248.71.109:18308", //jack passou aqui, e mandou dizer que conseguiu
       "207.180.242.94:18308" //sim, conseguiu e muito ls
};
} // CryptoNote
